"""
Based on: https://jeff.glass/2020/12/02/advent-of-code-2020-day-2-x/
...
of times a given letter must appear for the password to be valid. For example, 1-3 a means that the password must contain a at least 1 time and at most 3 times.
...
def isValid_Pass(low,high,letter,password):
...
print("The solution is " + str(len([line for line in data if isValidLine(line, isValid_Pass)])))
print("The solution is " + str(len([line for line in data if isValidLine(line, isValid_Toboggan)])))
